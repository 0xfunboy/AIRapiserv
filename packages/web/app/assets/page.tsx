  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400">Search and multi-chain mapping</p>
      </div>
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-4">
        <p className="text-sm text-slate-400">
          The full UI will include live search, chain filters, and manual overrides. For now this page shows seeded assets from the resolver.
        </p>
